...
type SendRestriction int32

const (
	SendRestriction_Unspecified SendRestriction = 0
	SendRestriction_Domain      SendRestriction = 1
	SendRestriction_Self        SendRestriction = 2
)

// Enum value maps for SendRestriction.
var (
	SendRestriction_name = map[int32]string{
		0: "Unspecified",
		1: "Domain",
		2: "Self",
	}
	SendRestriction_value = map[string]int32{
		"Unspecified": 0,
		"Domain":      1,
		"Self":        2,
	}
...
func (x SendRestriction) Enum() *SendRestriction {
	p := new(SendRestriction)
	*p = x
	return p
}

func (x SendRestriction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SendRestriction) Descriptor() protoreflect.EnumDescriptor {
	return file_userdb_proto_enumTypes[0].Descriptor()
}

func (SendRestriction) Type() protoreflect.EnumType {
	return &file_userdb_proto_enumTypes[0]
}

func (x SendRestriction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SendRestriction.Descriptor instead.
func (SendRestriction) EnumDescriptor() ([]byte, []int) {
...
type Password struct {
	...
	Meta   *UserMeta         `protobuf:"bytes,5,opt,name=meta,proto3" json:"meta,omitempty"`
}
...
func (x *Password) GetMeta() *UserMeta {
	if x != nil {
		return x.Meta
	}
	return nil
...
type UserMeta struct {
	...
	SendRestriction SendRestriction `protobuf:"varint,1,opt,name=sendRestriction,proto3,enum=userdb.SendRestriction" json:"sendRestriction,omitempty"`
}
...
func (x *UserMeta) GetSendRestriction() SendRestriction {
	if x != nil {
		return x.SendRestriction
	}
	return SendRestriction_Unspecified
}
...
var file_userdb_proto_rawDesc = []byte{
	...
	0x22, 0xb5, 0x01, 0x0a, 0x08, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x28, 0x0a,
	...
	,
	...
	0x64, 0x22, 0x08, 0x0a, 0x06, 0x44, 0x65, 0x6e, 0x69, 0x65, 0x64, 0x2a, 0x38, 0x0a, 0x0f, 0x53,
	0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0f,
	0x0a, 0x0b, 0x55, 0x6e, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x64, 0x10, 0x00, 0x12,
	0x0a, 0x0a, 0x06, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x53,
	0x65, 0x6c, 0x66, 0x10, 0x02, 0x42, 0x2c, 0x5a, 0x2a, 0x62, 0x6c, 0x69, 0x74, 0x69, 0x72, 0x69,
	0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x72, 0x2f, 0x67, 0x6f, 0x2f, 0x63, 0x68, 0x61, 0x73, 0x71,
	0x75, 0x69, 0x64, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x75, 0x73, 0x65,
	0x72, 0x64, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_userdb_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_userdb_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_userdb_proto_goTypes = []interface{}{
	(SendRestriction)(0), // 0: userdb.SendRestriction
	(*ProtoDB)(nil),      // 1: userdb.ProtoDB
	(*Password)(nil),     // 2: userdb.Password
	(*UserMeta)(nil),     // 3: userdb.UserMeta
	(*Scrypt)(nil),       // 4: userdb.Scrypt
	(*Plain)(nil),        // 5: userdb.Plain
	(*Denied)(nil),       // 6: userdb.Denied
	nil,                  // 7: userdb.ProtoDB.UsersEntry
}
var file_userdb_proto_depIdxs = []int32{
	7, // 0: userdb.ProtoDB.users:type_name -> userdb.ProtoDB.UsersEntry
	4, // 1: userdb.Password.scrypt:type_name -> userdb.Scrypt
	5, // 2: userdb.Password.plain:type_name -> userdb.Plain
	6, // 3: userdb.Password.denied:type_name -> userdb.Denied
	3, // 4: userdb.Password.meta:type_name -> userdb.UserMeta
	0, // 5: userdb.UserMeta.sendRestriction:type_name -> userdb.SendRestriction
	2, // 6: userdb.ProtoDB.UsersEntry.value:type_name -> userdb.Password
...
func file_userdb_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_userdb_proto_enumTypes,
